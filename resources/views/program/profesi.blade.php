...
<section class="hero-section">
  <div class="hero-bg-wrapper">
    <img src="{{ asset('img/profe.png') }}" alt="Banner Pelatihan Profesi">
    <div class="overlay"></div>
  </div>

  <div class="hero-content container">
    <h1 class="judul-hero">Pelatihan Profesi</h1>
    <p class="deskripsi-hero">
      Pelatihan intensif setahun penuh yang mempersiapkan peserta menjadi tenaga siap kerja di bidang digital.
    </p>
...
<section class="kursus-section py-5">
  <div class="container text-start">
    <h2 class="fw-bold mb-2 text-black">Kursus Peningkatan Profesi</h2>
    <p class="mb-4 text-black">
      Dilengkapi sertifikasi dan materi terbaru, kursus ini dirancang untuk kamu yang siap memimpin tim, naik jabatan, atau buka peluang karier baru
    </p>

    <div class="row row-cols-2 row-cols-md-4 g-4">
      @php
        $kursus = [
          ["title" => "Digital Technopreneur", "kategori" => "Profesi"],
          ["title" => "Digital Marketer", "kategori" => "Profesi"],
        ];
      @endphp
