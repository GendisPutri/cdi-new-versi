...
<section class="hero-section">
  <div class="hero-bg-wrapper">
    <img src="{{ asset('img/sertif.png') }}" alt="Banner Pelatihan Magang">
...
<section class="kursus-section py-5">
  <div class="container text-start">
    ...
    <p class="mb-4 text-black">
      Perkuat profil profesionalmu: dapatkan sertifikat resmi yang diakui industri seperti digital marketing bersertifikat, mobile marketing, dan e‑commerce. Sekali bayar langsung ikuti berbagai macam sertifikasi
    </p>

    <div class="row row-cols-2 row-cols-md-4 g-4">
      @php
        $kursus = [
          ["title" => "Teknik Jaringan", "kategori" => "Sertifikasi"],
          ["title" => "Software Development", "kategori" => "Sertifikasi"],
          ["title" => "Multimedia and Office", "kategori" => "Sertifikasi"],
          ["title" => "Project Management ", "kategori" => "Sertifikasi"],
          ["title" => "Digital Marketing", "kategori" => "Sertifikasi"],
          ["title" => "Fiber Optic", "kategori" => "Sertifikasi"],
        ];
      @endphp
